...
\newenvironment{FiveTrackSchedule}{
\settowidth{\en}{--}
\setlength{\w}{\linewidth}%
\settowidth{\tsl}{$\,$}
\addtolength{\w}{-2\tsl}%
...
\begin{longtable}{@{}|%
    ...
    >{\raggedright}%
    p{\tsl}|%
    >{\centering\arraybackslash}p{.20\w}|%
    >{\centering\arraybackslash}p{.20\w}|%
    >{\centering\arraybackslash}p{.20\w}|%
    >{\centering\arraybackslash}p{.20\w}|%
    >{\centering\arraybackslash}p{.20\w}|@{}}%
...
\newenvironment{SixTrackSchedule}{
\settowidth{\en}{--}
\setlength{\w}{\linewidth}%
\settowidth{\tsl}{$\,$}
\addtolength{\w}{-2\tsl}%
...
\begin{longtable}{@{}|%
    ...
    >{\raggedright}%
    p{\tsl}|%
    >{\centering\arraybackslash}p{.166\w}|%
    >{\centering\arraybackslash}p{.166\w}|%
    >{\centering\arraybackslash}p{.166\w}|%
    >{\centering\arraybackslash}p{.166\w}|%
    >{\centering\arraybackslash}p{.166\w}|%
...
\newcommand{\papertableentryauthors}[1]{
  \small
  %{\papertitle{#1}}}
  {\papertitle{#1}}\newline
  {\paperauthor{\citeauthorslastnamesonly{#1}}}}
...
\newcommand{\papertableentrysmall}[1]{
  \small
  %{\clipstring{\papertitle{#1}}}\newline
  {\papertitle{#1}}}
  %{\paperauthor{\citeauthorslastnamesonly{#1}}}}
...
\newenvironment{SixSessionOverview}[8]{
  \section[#1]{#1 Overview -- #2}
  \setheaders{#1}{#2}
  ...
  \begin{center}
    \righthyphenmin2
    \sloppy
%    \begin{longtable}{>{\RaggedRight}p{0.67in}|>{\RaggedRight}p{0.67in}|>{\RaggedRight}p{0.67in}|>{\RaggedRight}p{0.67in}|>{\RaggedRight}p{0.67in}|>{\RaggedRight}p{0.67in}}
    \begin{tabular}{>{\RaggedRight}p{0.67in}|>{\RaggedRight}p{0.67in}|>{\RaggedRight}p{0.67in}|>{\RaggedRight}p{0.67in}|>{\RaggedRight}p{0.67in}|>{\RaggedRight}p{0.67in}}
...
\newenvironment{SevenSessionOverview}[9]{
  \section[#1]{#1 Overview -- #2}
  \setheaders{#1}{#2}
%  \begin{adjustwidth}{-1.1cm}{}
  \begin{center}
    \righthyphenmin2
    \sloppy
    \begin{tabular}{>{\RaggedRight}p{0.57in}|>{\RaggedRight}p{0.57in}|>{\RaggedRight}p{0.57in}|>{\RaggedRight}p{0.57in}|>{\RaggedRight}p{0.57in}|>{\RaggedRight}p{0.57in}|>{\RaggedRight}p{0.57in}}
%    \begin{longtable}{>{\RaggedRight}p{0.57in}|>{\RaggedRight}p{0.57in}|>{\RaggedRight}p{0.57in}|>{\RaggedRight}p{0.57in}|>{\RaggedRight}p{0.57in}|>{\RaggedRight}p{0.57in}|>{\RaggedRight}p{0.57in}}
